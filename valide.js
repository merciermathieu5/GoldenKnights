/* Harnais de validation — Golden Knights de Vegas (jsdom) */
const fs = require('fs');
...
const ATTENDU = {
  equipe: 'VEGAS',
  taille: 26,
  echantillon: {nom: 'Aatu Raty', salaire: 1000000, ct: 0, ov: 76},
  masseSousContrat: 62300000,
  nbSousContrat: 15,
  dateSecours: '8 juillet 2026',
  nbEchus: 11,
  nbBackups: 0,
  masseTotale: 88350000
};
...
(async () => {
  ...
  W.localStorage.removeItem('vgk_resignatures_v1');
  W.localStorage.removeItem('vgk_transac_v1');
